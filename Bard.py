...
def MainExecution():
    ...
    while True:
        try:
            File = open("E:\\Jarvis\\Body\\SpeechRecognition.txt","r")     # you have to create a SpeechRecognition.txt 
            Data = File.read()
            File.close()
            FileHistory = open("E:\\Jarvis\\Brain\\HistoryChat.txt","r")  # you have to create a HistoryChat.txt
            ...
            if str(Data)==str(DataHistory):
                ...
                filenamedate = "E:\\Jarvis\\Brain\\DataBase\\" + filenamedate   # you have to create a DataBase Folder
                print(split_and_save_paragraphs(results, filename=filenamedate))

                FileHistory = open("E:\\Jarvis\\Brain\\HistoryChat.txt","w")    
